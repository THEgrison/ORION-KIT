...
$ISOS = @(
    @{ Name="SystemRescue 12.03";    Folder="Linux-et-Outils"; File="systemrescue-12.03-amd64.iso";                    Url="https://downloads.sourceforge.net/project/systemrescuecd/sysresccd-x86/systemrescue-12.03-amd64.iso";                                   Fallback="https://archive.org/download/systemrescue-12.03/systemrescue-12.03-amd64.iso";                Manual="https://www.system-rescue.org/Download/" },
